...
t.register.username = '用户名'
t.register.password = '密码'
t.register.captcha = '短信验证码'
...
t.dept = {}
t.dept.name = '名称'
t.dept.parentName = '上级单位'
t.dept.sort = '排序'
t.dept.parentNameDefault = '一级单位'
t.dept.chooseerror = '请选择单位'
t.dept.title = '选择单位'
